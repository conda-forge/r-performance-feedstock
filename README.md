...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/r-performance-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r-performance-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add r-performance
# for installing globally
pixi global install r-performance
```
...
It is possible to list all of the versions of `r-performance` available on your platform:
...
```
pixi search r-performance --channel conda-forge
```
